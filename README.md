...
|-------------------------------------------------------|------------------------------------------------|:----------------------------------------------------------:|
|Create post with valid fields.|Send POST request with uri `/posts` and body with valid data: existant userId, valid title and body. Then make a SELECT query to the table with posts in the database with id from the received response.|POST request returned response with status Created (201) and non-empty JSON with properties with the same values as in the request body, property "id" should be not null. SELECT query returned a row with the same field values as JSON.|
...
|Update post by valid and existant id with correct updatable info.|Send PUT request with uri `/posts/{id}` (id is valid and existant) and body with this data: valid userId, title and body. Then make a SELECT query to the table with posts in the database with id from uri.|PUT request returned response with status OK (200) and non-empty JSON with properties with the same values as in the request body (id as in uri `/posts/{id}`). SELECT query returned a row with the same field values as JSON.|
...
|Delete post by valid and existant id.|Send DELETE request with uri `/posts/{id}` (id is valid and existant). Then make a SELECT query to the table with posts in the database with id from uri.|DELETE request returned response with status OK (200) and non-empty JSON with property "id" as in uri `/posts/{id}`). SELECT query returned an empty row.|
...
|Complex HTTP requests test.|Send POST request with uri `/posts` and body with valid data: existant userId, valid title and body. Then send request GET `/posts/{id}` with id from the received response. Further send PUT request with uri `/posts/{id}` (id from the received response of POST request) and body with this data: valid userId, title and body. Finally, send DELETE request with uri `/posts/{id}` (id from the received response of POST request). Then make a SELECT query to the table with posts in the database with id from uri.|POST request returned response with status Created (201) and non-empty JSON with properties with the same values as in the request body, property "id" should be not null. GET request returned response with status OK (200) and non-empty JSON with properties with the same values as in the response body from POST request.  PUT request returned response with status OK (200) and non-empty JSON with properties with the same values as in the request body (id as in response body from POST request). DELETE request returned response with status OK (200) and non-empty JSON with  the same values as in the response body from POST request. SELECT query returned an empty row.|
